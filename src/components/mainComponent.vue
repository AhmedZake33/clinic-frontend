<template>
  <v-app>
    <div class="main">
      ...
      <div
        v-if="$route.params.id == 1 || $route.params.id == 5"
        class="secondHeading"
      >
        <v-row>
          <v-col
  ...
  watch: {
    ...
    type(data, old) {
      if (data == 1) {
        ...
        btn.style.color = '#fff'
        const other = document.getElementsByClassName('btn')[1]
        ...
        btn.style.backgroundColor = '#80afa8'
        btn.style.color = '#fff'
        const other = document.getElementsByClassName('btn')[0]
        other.style.backgroundColor = '#fff'
        other.style.color = '#80afa8'
      }
    },
